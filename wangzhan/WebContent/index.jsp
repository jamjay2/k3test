	 ...
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"菜单",
							"menus":[
									...
									{"menuid":"13","menuname":"hello","icon":"icon-users","url":" <%=request.getContextPath()%>/HelloWorld"},
									{"menuid":"14","menuname":"json","icon":"icon-role","url":"<%=request.getContextPath()%>/jsp/json.jsp"},
									{"menuid":"15","menuname":"权限设置","icon":"icon-set","url":"<%=request.getContextPath()%>/json"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="float:right; padding-right:20px;" class="head">欢迎 卢杰 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
        <span style="padding-left:10px; font-size: 16px; "><img src="images/blocks.gif" width="20" height="20" align="absmiddle" /> 欢迎来到我的小站</span>
    </div>
